...
Challenge proposto para avaliar habilidades práticas. Nesse caso, o objetivo era analisar dados de campanhas publicitárias, construir um modelo para prever o Klike Score e criar um sistema de recomendações para ajudar times criativos a melhorarem seus anúncios.
